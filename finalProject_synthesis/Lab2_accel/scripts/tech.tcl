...
set rm_clock_period 20.0 ;# Target clock period in ns of the macro
...
set rm_dont_use_list [list *BWP20* *LVT SDF* SED*]
...
set rm_period_jitter 0.030 ;# Cycle jitter (rise-to-rise) +/- N ns 
