...
#  Created on Mon May  4 13:55:18 2026                
#                                                     
#######################################################
...
restoreDesign top.design_planning.enc.dat top
...
report_constraint -all_violators > ../reports/layout/top-placeopt.constraint
report_area -out_file ../reports/layout/top-placeopt.area
report_design                      > ../reports/layout/${rm_core_top}-placeopt.design
reportFanoutViolation -max -outfile ../reports/layout/top-placeopt.fanout
reportCongestion -hotSpot -includeBlockage -overflow > ../reports/layout/top-placeopt.congestion
