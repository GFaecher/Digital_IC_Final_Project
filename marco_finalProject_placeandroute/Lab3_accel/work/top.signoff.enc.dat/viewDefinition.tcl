...
create_constraint_mode -name tt0p8v25c_mode\
   -sdc_files\
    [list ${::IMEX::dataVar}/mmmc/modes/tt0p8v25c_mode/tt0p8v25c_mode.sdc]
...
create_analysis_view -name typical -constraint_mode tt0p8v25c_mode -delay_corner tt_0p8v_25c_delay_corner -latency_file ${::IMEX::dataVar}/mmmc/views/typical/latency.sdc
...
set_analysis_view -setup [list normBC typical normWC] -hold [list normBC typical normWC]
